classdef spider_plot < matlab.graphics.chartcontainer.ChartContainer & ...
        matlab.graphics.chartcontainer.mixin.Legend
    %spider_plot Create a spider or radar plot with individual axes.
    %
    % Syntax:
    %   s = spider_plot(P)
    %   s = spider_plot(P, Name, Value, ...)
    %   s = spider_plot(parent, ___)
    %
    % Documentation:
